package org.wrmList.waitingRoom.common.controller;
...
import org.wrmList.waitingRoom.common.service.BaseService;
import org.wrmList.waitingRoom.shared.dto.PageDTO;
import org.wrmList.waitingRoom.util.annotation.IdExists;

@RestController
public abstract class BaseController<ID, CreateDTO, UpdateDTO, ResponseDTO> {
    ...
    public ResponseDTO findById(@IdExists(entityClass = Object.class) @PathVariable ID id) {
    ...
    @PatchMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public ResponseDTO updateById(@RequestBody UpdateDTO updateDTO, @IdExists(entityClass = Object.class) @PathVariable ID id) {
    ...
    public void deleteById(@IdExists(entityClass = Object.class) @PathVariable ID id) {
